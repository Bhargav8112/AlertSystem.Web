...
namespace AlertSystem.DataBase
{
    ...
    public partial class USER_MST
    {
        ...
        public string Library_menu { get; set; }
        public string Library_reader { get; set; }
        public string Library_menu_dept { get; set; }
        public string Ticket_User { get; set; }
        public string event_approval_user { get; set; }
        ...
        public Nullable<int> Tool_Trial_UserTYpe { get; set; }
    }
}
